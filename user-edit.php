        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="container-fluid">
                        <div class="py-2 ">
                            <a class="btn btn-dark  " href="user-list.php">
                        ...
                        <form action="doUpdateUser.php" method="post">
                            ...
                            <table class="table table-bordered vertical-align-middle">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input type="phone" class="form-control" name="phone" value="<?= $row["phone"]; ?>">
                            ...
                            <div class="py-2 d-flex justify-content-between">
                                <div><button type="submit" class="btn btn-dark">儲存</button>
                                    <a class="btn btn-dark " href="user.php?id=<?= $row["id"] ?>">取消</a>
                                </div>
                                <div><button type="button" data-bs-toggle="modal" data-bs-target="#alertModal" class="btn btn-danger">刪除資料</button></div>
                            </div>
