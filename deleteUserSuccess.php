    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          <div class="d-flex justify-content-center align-items-center flex-wrap pt-5" style="height: 180px">
            <h1>資料刪除成功</h1>
            <div class="w-100"></div>
            <a class="btn btn-secondary" href="user-list.php"><i class="fa-solid fa-reply"></i> 回使用者清單</a>
          </div>
        </div>
        <!-- /.container-fluid -->
      </div>
