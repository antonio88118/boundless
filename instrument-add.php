...
<body id="page-top">
                ...
                <div class="container-fluid">
                    ...
                    <div class="mx-3 py-3 row gx-5">
                        ...
                        <?php if (isset($_SESSION["error"]["message"])) : ?>
                            <div class="text-center text-danger pb-1"><?= $_SESSION["error"]["message"] ?></div>
                        <?php endif; ?>

                        <!-- 圖片顯示 -->
                        <div class="col-4">
                            <!-- Start of Form -->
                            <form action="doAddInstrument.php" method="post" enctype="multipart/form-data">
                        ...
                        <div class="col-8 pe-2">
                            <table class="table table-striped-columns">
                                ...
                                <tr class="row">
                                    ...
                                    <td class="col-3">
                                        <select select class="form-select d-inline-block py-1" style="width:auto;" name="brand">
                                    ...
                                    <td class="col-5 border-end">
                                        <!-- 類別 -->
                                        <select class="form-select d-inline-block py-1" style="width:auto;" name="category" id="category">
                                            <?php foreach ($categoryRows as $categoryRow) : ?>
                                                <option value="<?= $categoryRow["id"] ?>"><?= $categoryRow["name"] ?></option>
                                            <?php endforeach; ?>
                                        </select>
                                        ／
                                        <!-- 子類別 -->
                                        <select class="form-select d-inline-block py-1" style="width:auto;" name="subcategory" id="insert_subcategory">
                                                <option value="1">木吉他</option>
                                                <option value="2">電吉他</option>
                                        </select>
                                    </td>
                                </tr>
                                ...
                                <tr class="row">
                                    ...
                                    <td class="col-10 border-end p-1">
                                        <input type="number" class="form-control" style="width: 20%;" oninput="if(value.length>3)value=value.slice(0,3)" name="stock">
                                    </td>
                                </tr>
                            ...
                            <div class="text-center d-flex justify-content-center">
                                ...
                                <!-- 取消鍵 -->
                                <a class="btn btn-secondary me-5 px-3 fw-bold" href="instrument-list.php">取消</a>
    ...
    <script>
        ...
        categorySelected.addEventListener("change", function(){
            // console.log(categorySelected.options[categorySelected.selectedIndex].value);
            let categoryID = categorySelected.options[categorySelected.selectedIndex].value;
            $.ajax({
                method: "POST",
                url: "instrumentGetSubcategory.php",
                dataType: "json",
                data: {
            ...
            .done(function(response){
                ...
                if (status == 0) {
                    ...
                    let option_content = ""; // 用來存innerHTML的內容
                    // console.log(result);
                    ...
                    result.forEach(function(subcategory){
                        ...
                        option_content += `<option value="${subcategory_id}">${subcategory_name}</option>`; // 不是單引號！！
                    });
                    document.querySelector('#insert_subcategory').innerHTML = option_content;
