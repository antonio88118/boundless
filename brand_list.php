...
$pageCount=ceil($totalBrand/$perPage);
if($page_end > $totalBrand){
    $page_end = $totalBrand; 
}


$sql="SELECT * FROM brand WHERE valid=1 LIMIT $startItem, $perPage";
                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="d-flex justify-content-between">
                            <h1 class="h3 mb-2 text-gray-800 align-middle">樂器品牌管理</h1>
                            <a class="btn btn-dark px-4 m-3" href="add_brand.php"><i class="bi bi-plus-circle-fill me-2" title="新增樂器品牌"></i>新增樂器品牌</a>
                        </div>
                    </div>
                    <!-- DataTales Example -->
                    <div class="card shadow mb-4">
                        <div class="card-header py-4 d-flex justify-content-end" style="background-color: #ACACAC;">
                            <!-- Search -->
                            <h6 class="m-0 font-weight-bold text-dark my-auto">顯示<?=$page_start?> 到 <?=$page_end?>筆 共<?=$totalBrand?>筆 目前在第<?=$page?>頁 共<?=$pageCount?>頁</h6>
                        </div>
                        <div class="card-body">
                        <div class="table-responsive">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-end">
                                        <a class="btn btn-primary"  type="button" href="brand_edit.php?id=<?=$row["id"]?>">
                                        <i class="bi bi-pen-fill me-2"></i>修改品牌
                                        </a>
                                        <a type="button" class="btn btn-danger text-white" href="doDeletebrand.php?id=<?=$row["id"]?>"><i class="bi bi-trash3-fill me-2"></i>刪除品牌</a>
                                    </td>
                                </tr>
                                <?php endforeach; ?>
                            </tbody>
                            ...
                            <nav aria-label="Page navigation example">
                                <ul class="pagination d-flex justify-content-center">
                                    <li class="page-item">
                                    <a class="page-link" href="brand_list.php?page=1" aria-label="Previous">
                                    ...
                                    <?php else:?>
                                    <a class="page-link" href="brand_list.php?page=<?=$page-1?>" aria-label="Previous">
                                    <?php endif; ?>
                                    ...
                                    <a class="page-link" href="brand_list.php?page=<?=$i?>"><?=$i?></a>
                                    </li>
                                    <?php endfor; ?>
                                    <?php else: ?>
                                    ...
                                    <?php else:?>
                                    <a class="page-link" href="brand_list.php?page=<?=$page+1?>" aria-label="Next">
                                    <?php endif; ?>
                                        <span aria-hidden="true">&raquo;</span>
                                    </a>
                                    </li>
                                    <li class="page-item">
                                    <a class="page-link" href="brand_list.php?page=<?=$pageCount?>" aria-label="Previous">
