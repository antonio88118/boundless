...
// 製作分頁
$countSql = "SELECT instrument.* FROM instrument WHERE valid=1";
                            ...
                            <div class="p-2">
                                ...
                                <div class="my-2 mb-3 d-flex align-items-center justify-content-between">
                                    <?php if (!isset($_GET["search"])) : ?>
                                        <div class="ms-1 mb-1">資料共 <?= $countTotal ?> 筆</div>
                                        <!-- 若有搜尋 -->
                                    <?php else : ?>
                                        <div class="mb-2">
                                            <a class="btn btn-primary mb-2 me-2" href="instrument-list.php"><i class="fa-solid fa-reply"></i> 回總清單</a> 符合資料共 <?= $count ?> 筆
                                        </div>
                                    <?php endif; ?>
                                    <div>
                                        <?php if(!isset($_GET["search"])): ?>
